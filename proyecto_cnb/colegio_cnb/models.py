...
class Request(models.Model):
    cat=(('Voleibol','Voleibol'),('Futbol de Salon','Futbol de Salon'),('Basquetbol','Basquetbol'),('Futbol','Futbol'))
    ...
    stat=(('Pendiente','Pendiente'),('Aprobado','Aprobado'),('Jugando','Jugando'),('Campeonato Finalizado','Campeonato Finalizado'),('Liberado','Liberado'))
    status=models.CharField(max_length=50,choices=stat,default='Pendiente',null=True)
