...
def home_view(request):
    ...
    return render(request,'colegio_cnb/index.html')
...
def customerclick_view(request):
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request,'colegio_cnb/customerclick.html')

#for showing signup/login button for mechanics
def mechanicsclick_view(request):
    if request.user.is_authenticated:
        return HttpResponseRedirect('afterlogin')
    return render(request,'colegio_cnb/mechanicsclick.html')
...
def customer_signup_view(request):
    ...
    return render(request,'colegio_cnb/customersignup.html',context=mydict)
...
def mechanic_signup_view(request):
    ...
    return render(request,'colegio_cnb/mechanicsignup.html',context=mydict)
...
def afterlogin_view(request):
    if is_customer(request.user):
        ...
        if accountapproval:
            ...
            return render(request,'colegio_cnb/mechanic_wait_for_approval.html')
    else:
...
def admin_dashboard_view(request):
    ...
    return render(request,'colegio_cnb/admin_dashboard.html',context=dict)


@login_required(login_url='adminlogin')
def admin_customer_view(request):
    return render(request,'colegio_cnb/admin_customer.html')

@login_required(login_url='adminlogin')
def admin_view_customer_view(request):
    customers=models.Customer.objects.all()
    return render(request,'colegio_cnb/admin_view_customer.html',{'customers':customers})
...
def update_customer_view(request,pk):
    ...
    if request.method=='POST':
        ...
        if userForm.is_valid() and customerForm.is_valid():
            ...
            customerForm.save()
            return redirect('admin-view-customer')
    return render(request,'colegio_cnb/update_customer.html',context=mydict)
...
def admin_add_customer_view(request):
    ...
    return render(request,'colegio_cnb/admin_add_customer.html',context=mydict)
...
def admin_view_customer_enquiry_view(request):
    ...
    for enq in enquiry:
        customer=models.Customer.objects.get(id=enq.customer_id)
        customers.append(customer)
    return render(request,'colegio_cnb/admin_view_customer_enquiry.html',{'data':zip(customers,enquiry)})
...
def admin_view_customer_invoice_view(request):
    ...
    for enq in enquiry:
        ...
        customer=models.Customer.objects.get(id=enq['customer_id'])
        customers.append(customer)
    return render(request,'colegio_cnb/admin_view_customer_invoice.html',{'data':zip(customers,enquiry)})

@login_required(login_url='adminlogin')
def admin_mechanic_view(request):
    return render(request,'colegio_cnb/admin_mechanic.html')


@login_required(login_url='adminlogin')
def admin_approve_mechanic_view(request):
    mechanics=models.Mechanic.objects.all().filter(status=False)
    return render(request,'colegio_cnb/admin_approve_mechanic.html',{'mechanics':mechanics})
...
def approve_mechanic_view(request,pk):
    ...
    return render(request,'colegio_cnb/admin_approve_mechanic_details.html',{'mechanicSalary':mechanicSalary})
...
def admin_add_mechanic_view(request):
    ...
    return render(request,'colegio_cnb/admin_add_mechanic.html',context=mydict)


@login_required(login_url='adminlogin')
def admin_view_mechanic_view(request):
    mechanics=models.Mechanic.objects.all()
    return render(request,'colegio_cnb/admin_view_mechanic.html',{'mechanics':mechanics})
...
def update_mechanic_view(request,pk):
    ...
    if request.method=='POST':
        ...
        if userForm.is_valid() and mechanicForm.is_valid():
            ...
            mechanicForm.save()
            return redirect('admin-view-mechanic')
    return render(request,'colegio_cnb/update_mechanic.html',context=mydict)

@login_required(login_url='adminlogin')
def admin_view_mechanic_salary_view(request):
    mechanics=models.Mechanic.objects.all()
    return render(request,'colegio_cnb/admin_view_mechanic_salary.html',{'mechanics':mechanics})
...
def admin_request_view(request):
    return render(request,'colegio_cnb/admin_request.html')
...
def admin_view_request_view(request):
    ...
    for enq in enquiry:
        customer=models.Customer.objects.get(id=enq.customer_id)
        customers.append(customer)
    return render(request,'colegio_cnb/admin_view_request.html',{'data':zip(customers,enquiry)})
...
def change_status_view(request,pk):
    ...
    return render(request,'colegio_cnb/admin_approve_request_details.html',{'adminenquiry':adminenquiry})
...
def admin_add_request_view(request):
    ...
    if request.method=='POST':
        ...
        if enquiry.is_valid() and adminenquiry.is_valid():
            ...
            enquiry_x.mechanic=adminenquiry.cleaned_data['mechanic']
            enquiry_x.cost=adminenquiry.cleaned_data['cost']
            enquiry_x.status='Aprobado'
            enquiry_x.save()

        else:
            print("form is invalid")
        return HttpResponseRedirect('admin-view-request')
    return render(request,'colegio_cnb/admin_add_request.html',context=mydict)

@login_required(login_url='adminlogin')
def admin_approve_request_view(request):
    enquiry=models.Request.objects.all().filter(status='Pendiente')
    return render(request,'colegio_cnb/admin_approve_request.html',{'enquiry':enquiry})
...
def admin_view_service_cost_view(request):
    ...
    for enq in enquiry:
        ...
        customers.append(customer)
    print(customers)
    return render(request,'colegio_cnb/admin_view_service_cost.html',{'data':zip(customers,enquiry)})
...
def update_cost_view(request,pk):
    ...
    return render(request,'colegio_cnb/update_cost.html',{'updateCostForm':updateCostForm})



@login_required(login_url='adminlogin')
def admin_mechanic_attendance_view(request):
    return render(request,'colegio_cnb/admin_mechanic_attendance.html')
...
def admin_take_attendance_view(request):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            print('form invalid')
    return render(request,'colegio_cnb/admin_take_attendance.html',{'mechanics':mechanics,'aform':aform})
...
def admin_view_attendance_view(request):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            return render(request,'colegio_cnb/admin_view_attendance_page.html',{'mylist':mylist,'date':date})
        else:
            print('form invalid')
    return render(request,'colegio_cnb/admin_view_attendance_ask_date.html',{'form':form})

@login_required(login_url='adminlogin')
def admin_report_view(request):
    reports=models.Request.objects.all().filter(Q(status="Campeonato Finalizado") | Q(status="Liberado"))
    dict={
        'reports':reports,
    }
    return render(request,'colegio_cnb/admin_report.html',context=dict)


@login_required(login_url='adminlogin')
def admin_feedback_view(request):
    feedback=models.Feedback.objects.all().order_by('-id')
    return render(request,'colegio_cnb/admin_feedback.html',{'feedback':feedback})
...
def customer_dashboard_view(request):
    ...
    work_in_progress=models.Request.objects.all().filter(customer_id=customer.id,status='Jugando').count()
    work_completed=models.Request.objects.all().filter(customer_id=customer.id).filter(Q(status="Campeonato Finalizado") | Q(status="Liberado")).count()
    new_request_made=models.Request.objects.all().filter(customer_id=customer.id).filter(Q(status="Pendiente") | Q(status="Aprobado")).count()
    bill=models.Request.objects.all().filter(customer_id=customer.id).filter(Q(status="Campeonato Finalizado") | Q(status="Liberado")).aggregate(Sum('cost'))
    print(bill)
    dict={
    ...
    return render(request,'colegio_cnb/customer_dashboard.html',context=dict)
...
def customer_request_view(request):
    customer=models.Customer.objects.get(user_id=request.user.id)
    return render(request,'colegio_cnb/customer_request.html',{'customer':customer})
...
def customer_view_request_view(request):
    customer=models.Customer.objects.get(user_id=request.user.id)
    enquiries=models.Request.objects.all().filter(customer_id=customer.id , status="Pendiente")
    return render(request,'colegio_cnb/customer_view_request.html',{'customer':customer,'enquiries':enquiries})
...
def customer_view_approved_request_view(request):
    customer=models.Customer.objects.get(user_id=request.user.id)
    enquiries=models.Request.objects.all().filter(customer_id=customer.id).exclude(status='Pendiente')
    return render(request,'colegio_cnb/customer_view_approved_request.html',{'customer':customer,'enquiries':enquiries})
...
def customer_view_approved_request_invoice_view(request):
    customer=models.Customer.objects.get(user_id=request.user.id)
    enquiries=models.Request.objects.all().filter(customer_id=customer.id).exclude(status='Pendiente')
    return render(request,'colegio_cnb/customer_view_approved_request_invoice.html',{'customer':customer,'enquiries':enquiries})
...
def customer_add_request_view(request):
    ...
    return render(request,'colegio_cnb/customer_add_request.html',{'enquiry':enquiry,'customer':customer})
...
def customer_profile_view(request):
    customer=models.Customer.objects.get(user_id=request.user.id)
    return render(request,'colegio_cnb/customer_profile.html',{'customer':customer})
...
def edit_customer_profile_view(request):
    ...
    return render(request,'colegio_cnb/edit_customer_profile.html',context=mydict)
...
def customer_invoice_view(request):
    customer=models.Customer.objects.get(user_id=request.user.id)
    enquiries=models.Request.objects.all().filter(customer_id=customer.id).exclude(status='Pendiente')
    return render(request,'colegio_cnb/customer_invoice.html',{'customer':customer,'enquiries':enquiries})
...
def customer_feedback_view(request):
    ...
    if request.method=='POST':
        ...
        if feedback.is_valid():
            ...
            print("form is invalid")
        return render(request,'colegio_cnb/feedback_sent_by_customer.html',{'customer':customer})
    return render(request,'colegio_cnb/customer_feedback.html',{'feedback':feedback,'customer':customer})
#============================================================================================
...
def mechanic_dashboard_view(request):
    ...
    work_in_progress=models.Request.objects.all().filter(mechanic_id=mechanic.id,status='Jugando').count()
    work_completed=models.Request.objects.all().filter(mechanic_id=mechanic.id,status='Campeonato Finalizado').count()
    new_work_assigned=models.Request.objects.all().filter(mechanic_id=mechanic.id,status='Aprobado').count()
    dict={
    'work_in_progress':work_in_progress,
    'work_completed':work_completed,
    ...
    return render(request,'colegio_cnb/mechanic_dashboard.html',context=dict)
...
def mechanic_work_assigned_view(request):
    ...
    return render(request,'colegio_cnb/mechanic_work_assigned.html',{'works':works,'mechanic':mechanic})
...
def mechanic_update_status_view(request,pk):
    ...
    return render(request,'colegio_cnb/mechanic_update_status.html',{'updateStatus':updateStatus,'mechanic':mechanic})
...
def mechanic_attendance_view(request):
    ...
    return render(request,'colegio_cnb/mechanic_view_attendance.html',{'attendaces':attendaces,'mechanic':mechanic})
...
def mechanic_feedback_view(request):
    ...
    if request.method=='POST':
        ...
        if feedback.is_valid():
            ...
            print("form is invalid")
        return render(request,'colegio_cnb/feedback_sent.html',{'mechanic':mechanic})
    return render(request,'colegio_cnb/mechanic_feedback.html',{'feedback':feedback,'mechanic':mechanic})

@login_required(login_url='mechaniclogin')
@user_passes_test(is_mechanic)
def mechanic_salary_view(request):
    mechanic=models.Mechanic.objects.get(user_id=request.user.id)
    workdone=models.Request.objects.all().filter(mechanic_id=mechanic.id).filter(Q(status="Campeonato Finalizado") | Q(status="Liberado"))
    return render(request,'colegio_cnb/mechanic_salary.html',{'workdone':workdone,'mechanic':mechanic})

@login_required(login_url='mechaniclogin')
@user_passes_test(is_mechanic)
def mechanic_profile_view(request):
    mechanic=models.Mechanic.objects.get(user_id=request.user.id)
    return render(request,'colegio_cnb/mechanic_profile.html',{'mechanic':mechanic})
...
def edit_mechanic_profile_view(request):
    ...
    return render(request,'colegio_cnb/edit_mechanic_profile.html',context=mydict)
...
def aboutus_view(request):
    return render(request,'colegio_cnb/aboutus.html')

def acerca_view(request):
    return render(request,'colegio_cnb/acerca.html')

def gallery_view(request):
    return render(request,'colegio_cnb/gallery.html')

def historia_view(request):
    return render(request,'colegio_cnb/historia.html')

def noticia_view(request):
    return render(request,'colegio_cnb/noticia.html')
...
def contactus_view(request):
    ...
    if request.method == 'POST':
        ...
        if sub.is_valid():
            ...
            return render(request, 'colegio_cnb/contactussuccess.html')
    return render(request, 'colegio_cnb/contactus.html', {'form':sub})
