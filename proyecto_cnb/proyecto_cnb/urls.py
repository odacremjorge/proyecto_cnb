"""proyecto_cnb URL Configuration
...
urlpatterns = [
    ...
    path('customerlogin', LoginView.as_view(template_name='colegio_cnb/customerlogin.html'),name='customerlogin'),
    path('mechaniclogin', LoginView.as_view(template_name='colegio_cnb/mechaniclogin.html'),name='mechaniclogin'),
    path('adminlogin', LoginView.as_view(template_name='colegio_cnb/adminlogin.html'),name='adminlogin'),
    ...
    path('logout', LogoutView.as_view(template_name='colegio_cnb/index.html'),name='logout'),

    path('aboutus', views.aboutus_view),
    path('acerca', views.acerca_view),
    path('gallery', views.gallery_view),
    path('historia', views.historia_view),
    path('noticia', views.noticia_view),
